# Generated by Django 5.0.6 on 2025-04-09 02:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('floor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cameras', to='backend_app.floor')),
            ],
        ),
        migrations.CreateModel(
            name='SeatDetection',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peak_hour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='backend_app.peakhour')),
        ...
        migrations.AddField(
            model_name='peakhour',
            name='cafe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='peak_hours', to='backend_app.usercafe'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['month'], name='backend_app_month_c69487_idx'),
        ),
        migrations.AddIndex(
            model_name='seatdetection',
            index=models.Index(fields=['seat'], name='backend_app_seat_id_3004e7_idx'),
        ),
        migrations.AddIndex(
            model_name='seatdetection',
            index=models.Index(fields=['time_start'], name='backend_app_time_st_156db8_idx'),
        ),
    ]
